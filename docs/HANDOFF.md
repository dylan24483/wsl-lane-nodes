...
> **⚡ ADDENDUM 2026-07-21 — REV-D REMEDIATION CAMPAIGN COMPLETE (Codex NO-GO audit C1–C3/H1–H8/M1–M7 remediated). *[Board figures + fab-package path in THIS block are SUPERSEDED by the round-2 addendum below — 271/223 and `fab_revD_2026-07-21_r2/` are the real ones.]***
...
> **⚡ ADDENDUM 2026-07-21 (later) — ROUND-2 REMEDIATION, BOARD/BOM/EXPORT SLICE (Codex round-2 findings R2-2/R2-3/R2-4/R2-5/R2-6/R2-15). THIS is the current rev-D board state:**
