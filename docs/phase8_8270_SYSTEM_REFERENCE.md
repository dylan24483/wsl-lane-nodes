...
- **Safety architecture:** preserve TB/SC interlock + stop/CIS breaker chain in hardware; NE555 watchdog (relays drop on Pi death); MCU co-processor for cam-stop timing; **fail-safe-off + require manual-intervention on power restore.**
